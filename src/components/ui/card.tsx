  ...
  "text-card-foreground transition-[border-color,box-shadow,transform] duration-200",
  {
    variants: {
      variant: {
        ...
        // Editorial photo-card: tighter border, elevated shadow on hover
        "photo-card":
          "rounded-lg overflow-hidden bg-surface border border-border hover:border-coral/40 hover:shadow-elevated hover:-translate-y-0.5",
      },
    },
    defaultVariants: {
      variant: "default",
