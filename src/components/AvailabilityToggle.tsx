...
export default function AvailabilityToggle() {
  ...
  const handleActivate = async () => {
    ...
    if (error) {
      toast.error("Failed to activate availability");
    } else {
      ...
      >
        {isAvailable ? (
          <>
            ...
            Available Now
            <span className="text-primary/60 text-xs font-normal">· Tap to disable</span>
          </>
        ) : (
          <>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm px-4">
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-heading text-lg font-bold text-foreground">Set Availability</h3>
            ...
            <p className="font-body text-sm text-muted-foreground mb-4">
              Let others know you're available for TFP shoots right now!
            </p>

            <div className="space-y-2 mb-4">
              <label className="text-xs font-body text-muted-foreground">How long?</label>
            ...
            <div className="mb-5">
              ...
              <textarea
                ...
                placeholder="E.g., 'Free today 2-6pm in downtown Boston'"
